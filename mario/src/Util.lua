...
--[[
    Adv: given a flag atlas, generate quads for posts
]]
function GeneratePostQuads(atlas)
    spritesheet = {}
    ...
    for j = 1, 4 do
        ...
        for i = 1, 3 do
            table.insert(spritesheet,
                love.graphics.newQuad(x, (i - 1) * tileheight, tilewidth,
                tileheight, atlas:getDimensions())
            )   
        end
        x = x + tilewidth
...
--[[
    Adv: Given the flag atlas, generate quads for flags
]]
